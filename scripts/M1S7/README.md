# Module 1 - Week 7 (Database Modeling)

This directory contains database modeling files (Entity-Relationship diagrams) created as exercises for Module 1, Week 7.
